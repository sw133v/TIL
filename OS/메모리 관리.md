...
![image-20220219191626969](.\DeadLock\image-20220219191626969.png)
...
![image-20220222000849422](.\DeadLock\address_Translation_architecture)

  

![image-20220222002222283](.\DeadLock\TLB)
...
![image-20220222203301805](.\DeadLock\hit_ratio)
...
![image-20220222204157595](.\DeadLock\tlpt)

![image-20220222210244812](.\DeadLock\TLPT_ex)



![image-20220222205710722](.\DeadLock\tlevel_scheme)

level이 높을수록 접근횟수가 증가(tlb를 주로 통해서 접근회수를 떨구는 식으로 사용)

![image-20220222210526538](.\DeadLock\v_iv_bit)
...
![image-20220222212454978](.\DeadLock\inverted_page_table)

물리적 주소를 주면 해당 물리적 주소의 내용(논리적 주소)을 반환

##### shared pages

![image-20220222213921690](.\DeadLock\shared_pages)
...
* Segmentation
  ...
  <img src=".\DeadLock\segment_logical_unit" alt="image-20220222215538041" style="zoom:50%;" />
...
![image-20220222215902474](.\DeadLock\segmentHW)
