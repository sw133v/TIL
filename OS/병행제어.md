...
* Bounded-Buffer Problem(Producer-Consumer Problem)
  ...
  * Consumer : 버퍼에서 데이터를 꺼내가는 역할
  ...
  ![image-20220217225330915](.\병행제어\image-20220217225330915.png)

 비어있는 버퍼를 새는용도로는 counting 세마포어 가 적절하고

producer나 consumer가 사용할 버퍼를 락을 걸때는 binary 세마포어가 적절함

![image-20220217232415007](.\병행제어\image-20220217232415007.png)
...
![image-20220217232832774](.\병행제어\image-20220217232832774.png)
...
![image-20220217234225930](.\병행제어\image-20220217234225930.png)
...
![image-20220217235128222](.\병행제어\image-20220217235128222.png)
...
![image-20220219143508836](.\병행제어\image-20220219143508836.png)

자원에 접근할려면 모니터에 정의된 구조를 통해서만 접근 할 수 있게끔 설계

-> 락을 따로 걸 필요가 없음

![image-20220219143617761](.\병행제어\image-20220219143617761.png)



![image-20220219143943418](.\병행제어\image-20220219143943418.png)



> Bounded-Buffer Problem 경우시

![image-20220219150006611](.\병행제어\image-20220219150006611.png)



> Dining-Philosophers Problem

![image-20220219150022108](.\병행제어\image-20220219150022108.png)
